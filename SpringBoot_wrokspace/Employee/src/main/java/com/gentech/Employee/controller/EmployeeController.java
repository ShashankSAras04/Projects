...
public class EmployeeController {
    ...
    {
        return new ResponseEntity<>(service.getEmployeeByJobName(jobname),HttpStatus.OK);
    }
    @GetMapping("employees/filterBycityandstate")
    public ResponseEntity<List<EmployeeDto>> getEmployeesByCityNameAndState(@RequestParam String city, @RequestParam String state)
    {
        return  new ResponseEntity<>(service.getEmployeesByCityNameAndStateName(city,state),HttpStatus.OK);
    }
